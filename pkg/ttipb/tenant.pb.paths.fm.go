...
var TenantFieldPathsNested = []string{
	...
	"billing",
	"billing.provider",
	"billing.provider.aws_saas_marketplace",
	"billing.provider.aws_saas_marketplace.customer_identifier",
	"billing.provider.aws_saas_marketplace.product_code",
...
var CreateTenantRequestFieldPathsNested = []string{
	...
	"tenant.billing.provider.aws_saas_marketplace",
	"tenant.billing.provider.aws_saas_marketplace.customer_identifier",
	"tenant.billing.provider.aws_saas_marketplace.product_code",
