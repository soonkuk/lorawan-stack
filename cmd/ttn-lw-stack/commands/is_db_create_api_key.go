...
var (
	createAPIKeyCommand = &cobra.Command{
		Use:   "create-admin-api-key",
		Short: "Create an API key with full rights on user in the Identity Server database",
...
func init() {
	createAPIKeyCommand.Flags().String("id", "admin", "User ID")
